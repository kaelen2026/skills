...
Run as: python3 check/scripts/audit_signals.py --root <path>
"""
...
# The file-walk helpers below are kept inline on purpose. This script ships
# standalone and runs inside an arbitrary target project, so it imports only
# stdlib. Do not hoist them into a shared module: that would couple a
